...
#
# Only difference between this file and Analysis.R is that this saves figures with _Report
# naming convention to produce figures only for report days.
#
# Things to calculate:
...
# USDA Report dates for 2008-2013: Crop Production, WASDE, Grain Stocks, 
...
# Delete Limit days when there were no quote revisions. Couldn't make all delitions in one line; not sure why not.
  dates <- subset(dates, dates != c('100112'))
