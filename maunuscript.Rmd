...
```{r, echo=FALSE, warning=FALSE, fig.height= 6.5, fig.width=6.5}
library(ggplot2)
library(gridExtra)
library(data.table)
...
numasksplot <- ggplot(DT[variable %in% c("NumberofAsks")], aes(TradeDate, value, colour=Deferreds, group=Deferreds)) +
  ...
  scale_colour_grey(start = .9, end = .25) +
  #geom_smooth() +
  scale_size_area() +
...
Figure 1: Price Levels, Number of Ask Quotes, Number of Bid Quotes, and Number of Transactions
