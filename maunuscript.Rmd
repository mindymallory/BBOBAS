...
Figure displays data for the corn futures market from 1/14/2008 to 12/31/2011 for the nearby contract. The September contract is excluded due to the possibility of 'old crop' and 'new crop' both being delivered on this contract. To form the continuous nearby series contracts are rolled to the next contract prior to entering the delivery month. 
...
![Testing out how this works out](test.png)
