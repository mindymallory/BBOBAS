...
Every day, we define the first to mature (nearby), second to mature, and third contracts to mature. To avoid undesirable delivery month effects, we roll these definitions at the end of the month prior to contract maturity (For example, on March 1st the May futures contract is considered the nearby, and so forth). 
