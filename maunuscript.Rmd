...
In figure 1 contemporaneous correlation between the nearby and one, two, and three deferred maturity contracts are displayed. Correlations between both the nearby bid and deferred bids in panel A and nearby offers and deferred offers in panel B seem to have fairly stable means beginning around 0.6 at the start of the trading day and falling slightly to around 0.5 as trading progresses. The standard errors tend to exhibit less homogeneity in their patterns through the trading day. Specifically, standard deviations tend to be wider during the middle of the day when less information transmission may be taking place then the open and close of the markets.
...
If there had been a difference in the pattern of correlations on USDA report days, one would expect the first ten minutes of trading to display the largest effect. Contrary to this, however, there does not seem to be any discernible effect of USDA report releases on the market open, or in any other time bin (it is perhaps slightly higher in the first bin, but not pronounced). Two primary causes are suspected: 1) Since we removed days where the report release corresponded to limit price moves, we systematically removed report days where the most important information was conferred on the market. It is possible that the remaining days corresponded to USDA reports that contained relatively less relevant market information, or they contained information market participants widely expected beforehand. 2) Since USDA reports were released prior to the market open during this time period, the information may have already been fully incorporated by market participants by the time the market opened, resulting in no discernible difference in the pattern of correlations in the first (and subsequent) time bins.
...
Figure 4. Contemporaneous Correlation with Nearby on USDA Report Days - No Zeros


![](Bid_plot_timelag.png)
![](OFR_plot_timelag.png)
Figure 5. Contemporaneous and Time-lagged Correlations between the Nearby and One-deferred Contract

![](Bid_plot_timelag_report.png)
![](OFR_plot_timelag_report.png)
Figure 6. Contemporaneous and Time-lagged Correlations between the Nearby and One-deferred Contract on USDA Report Days

![](Bid_plot_timelag1N.png)
![](OFR_plot_timelag1N.png)
Figure 7. Contemporaneous and Time-lagged Correlations between the One-deferred Contract and Nearby (Price discovery in the distant) 

![](BIDOFR_plot.png)
![](OFRBID_plot.png)
Figure 8. Contemporaneous Correlations with Nearby Bid-to-Ask and Ask-to-Bid - Keep Zeros

![](BIDOFR_plot_timelag.png)
![](OFRBID_plot_timelag.png)
Figure 9. Contemporaneous and Time-lagged Correlations with Nearby Bid-to-Ask and Ask-to-Bid - No Zeros
