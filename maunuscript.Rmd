...
Figure displays data for the corn futures market from 1/14/2008 to 12/31/2011 for the nearby, first deferred, and second deferred contracts. The September contract is excluded due to the possibility of 'old crop' and 'new crop' both being delivered on this contract. Nearby, 1 Deferred, and 2 Deferred contracts are rolled to the next contract prior to entering the delivery month. 
